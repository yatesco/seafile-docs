...
<ul>
<li>
<a href="#seafile-web-api-v2">Seafile Web API V2</a>
<ul>
    ...
    <ul>
        ...
        <li><a href="#admin-get-desktop-devices">Admin Get Desktop Devices</a></li>
        <li><a href="#admin-get-mobile-devices">Admin Get Mobile Devices</a></li>
        <li><a href="#admin-unlink-user-device">Admin Unlink User Device</a></li>
        <li><a href="#admin-get-device-errors">Admin Get Device Errors</a></li>
    </ul>
    </li>
    <li>
    <a href="#admin-log">Admin Log</a>
    <ul>
        <li><a href="#admin-get-login-log">Admin Get Login Log</a></li>
        <li><a href="#admin-get-file-audit-log">Admin Get File Audit Log</a></li>
        <li><a href="#admin-get-file-update-log">Admin Get File Update Log</a></li>
        <li><a href="#admin-get-perm-audit-log">Admin Get Permission Audit Log</a></li>
    </ul>
    </li>
...
### <a id="admin-get-desktop-devices"></a>Admin Get Desktop Devices ##
...
### <a id="admin-get-mobile-devices"></a>Admin Get Mobile Devices ##
...
### <a id="admin-unlink-user-device"></a>Admin Unlink User Device ##
...
### <a id="admin-get-device-errors"></a>Admin Get Device Errors ##
...
## <a id="admin-log"></a>Admin Log ##

### <a id="admin-get-login-log"></a>Admin Get Login Log ##

**GET** https://cloud.seafile.com/api/v2.1/admin/login/?start=2016-03-20&end=2016-03-31

**Sample request**

    curl -H "Authorization: Token f2210dacd9c6ccb8133606d94ff8e61d99b477fd" -H 'Accept: application/json; indent=4' https://cloud.seafile.com/api/v2.1/admin/login/?start=2016-03-20&end=2016-03-31
...
### <a id="admin-get-file-audit-log"></a>Admin Get File Audit Log ##

**GET** https://cloud.seafile.com/api/v2.1/admin/file-audit/?start=2016-03-20&end=2016-03-31

**Sample request**

    curl -H "Authorization: Token f2210dacd9c6ccb8133606d94ff8e61d99b477fd" -H 'Accept: application/json; indent=4' https://cloud.seafile.com/api/v2.1/admin/file-audit/?start=2016-03-20&end=2016-03-31
...
### <a id="admin-get-file-update-log"></a>Admin Get File Update Log ##

**GET** https://cloud.seafile.com/api/v2.1/admin/file-update/?start=2016-03-20&end=2016-03-31

**Sample request**

    curl -H "Authorization: Token f2210dacd9c6ccb8133606d94ff8e61d99b477fd" -H 'Accept: application/json; indent=4' https://cloud.seafile.com/api/v2.1/admin/file-update/?start=2016-03-20&end=2016-03-31
...
### <a id="admin-get-perm-audit-log"></a>Admin Get Permission Audit Log ##

**GET** https://cloud.seafile.com/api/v2.1/admin/perm-audit/?start=2016-03-20&end=2016-03-31

**Sample request**

    curl -H "Authorization: Token f2210dacd9c6ccb8133606d94ff8e61d99b477fd" -H 'Accept: application/json; indent=4' https://cloud.seafile.com/api/v2.1/admin/perm-audit/?start=2016-03-20&end=2016-03-31
